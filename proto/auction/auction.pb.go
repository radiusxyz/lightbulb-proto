...
type StartAuctionRequest struct {
	...
	Info          *AuctionInfo           `protobuf:"bytes,2,opt,name=info,proto3" json:"info,omitempty"`                       // The details of the auction to start.
...
func (x *StartAuctionRequest) GetChainId() int64 {
	if x != nil {
		return x.ChainId
	}
	return 0
...
type SubmitBidRequest struct {
	...
	Bid           *Bid                   `protobuf:"bytes,3,opt,name=bid,proto3" json:"bid,omitempty"`                              // The bid details to submit.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubmitBidRequest) GetChainId() int64 {
	if x != nil {
		return x.ChainId
	}
	return 0
...
type SubmitBidResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"` // Whether the bid was successfully submitted.
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`  // Additional information about the operation.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SubmitBidBatchRequest struct {
	...
	ChainId       int64                  `protobuf:"varint,1,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`      // The unique identifier of the chain.
	AuctionId     string                 `protobuf:"bytes,2,opt,name=auction_id,json=auctionId,proto3" json:"auction_id,omitempty"` // The unique identifier of the auction.
	Bids          []*Bid                 `protobuf:"bytes,3,rep,name=bids,proto3" json:"bids,omitempty"`                            // The list of bids to submit.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubmitBidBatchRequest) GetChainId() int64 {
	if x != nil {
		return x.ChainId
	}
	return 0
...
type GetAuctionInfoRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChainId       uint64                 `protobuf:"varint,1,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`      // The unique identifier of the chain.
	AuctionId     string                 `protobuf:"bytes,2,opt,name=auction_id,json=auctionId,proto3" json:"auction_id,omitempty"` // The unique identifier of the auction.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetAuctionInfoRequest) GetChainId() uint64 {
	if x != nil {
		return x.ChainId
	}
	return 0
...
type GetAuctionInfoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Info          *AuctionInfo           `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"` // The details of the auction.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetAuctionInfoResponse) GetInfo() *AuctionInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
type AuctionInfo struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Id              string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                                  // The unique identifier of the auction.
	StartTime       int64                  `protobuf:"varint,2,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`                  // The start time of the auction (Unix timestamp in milliseconds).
	EndTime         int64                  `protobuf:"varint,3,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`                        // The end time of the auction (Unix timestamp in milliseconds).
	SellerAddress   string                 `protobuf:"bytes,4,opt,name=seller_address,json=sellerAddress,proto3" json:"seller_address,omitempty"`       // The address of the seller.
	BlockNumber     int64                  `protobuf:"varint,5,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"`            // The block number where the auction is registered.
	BlockspaceSize  int64                  `protobuf:"varint,6,opt,name=blockspace_size,json=blockspaceSize,proto3" json:"blockspace_size,omitempty"`   // The block space size being auctioned.
	SellerSignature string                 `protobuf:"bytes,7,opt,name=seller_signature,json=sellerSignature,proto3" json:"seller_signature,omitempty"` // The seller's signature for the auction.
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type Bid struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	BidderAddr      string                 `protobuf:"bytes,1,opt,name=bidder_addr,json=bidderAddr,proto3" json:"bidder_addr,omitempty"`                // The address of the bidder.
	BidAmount       int64                  `protobuf:"varint,2,opt,name=bid_amount,json=bidAmount,proto3" json:"bid_amount,omitempty"`                  // The amount of the bid.
	BidderSignature string                 `protobuf:"bytes,3,opt,name=bidder_signature,json=bidderSignature,proto3" json:"bidder_signature,omitempty"` // The signature of the bidder.
	TxList          []*Tx                  `protobuf:"bytes,4,rep,name=tx_list,json=txList,proto3" json:"tx_list,omitempty"`                            // The list of transactions associated with the bid.
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type AuctionState struct {
	...
	Bids          []*Bid                 `protobuf:"bytes,2,rep,name=bids,proto3" json:"bids,omitempty"`                                  // The list of all bids submitted.
	IsEnded       bool                   `protobuf:"varint,3,opt,name=is_ended,json=isEnded,proto3" json:"is_ended,omitempty"`            // Whether the auction has ended.
	HighestBid    int64                  `protobuf:"varint,4,opt,name=highest_bid,json=highestBid,proto3" json:"highest_bid,omitempty"`   // The current highest bid amount.
	Winner        string                 `protobuf:"bytes,5,opt,name=winner,proto3" json:"winner,omitempty"`                              // The address of the winning bidder, if available.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_proto_auction_auction_proto_rawDesc = []byte{
	...
	0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x5a, 0x0a, 0x13, 0x53, 0x74, 0x61, 0x72, 0x74, 0x41,
	0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a,
	0x08, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x2e, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e,
	0x66, 0x6f, 0x22, 0x4a, 0x0a, 0x14, 0x53, 0x74, 0x61, 0x72, 0x74, 0x41, 0x75, 0x63, 0x74, 0x69,
	...
	0x0a, 0x10, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x42, 0x69, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	0x01, 0x28, 0x04, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a,
	0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x42, 0x0a, 0x16, 0x47,
	0x65, 0x74, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73,
	...
	0x30, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x54, 0x6f, 0x62, 0x52,
	...
	0x64, 0x22, 0x3c, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x54, 0x6f,
	0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x07, 0x74, 0x78, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x61, 0x75, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x54, 0x78, 0x52, 0x06, 0x74, 0x78, 0x4c, 0x69, 0x73, 0x74, 0x22,
	0x33, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61,
	...
	0x69, 0x6e, 0x49, 0x64, 0x22, 0x46, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x41, 0x75, 0x63, 0x74, 0x69,
	...
	0x0b, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x73, 0x65, 0x6c, 0x6c, 0x65, 0x72,
	0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d,
	0x73, 0x65, 0x6c, 0x6c, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x21, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x79, 0x7a, 0x2f, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x62, 0x75, 0x6c, 0x62, 0x2d, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
...
var file_proto_auction_auction_proto_goTypes = []any{
	...
	(*GetAuctionInfoRequest)(nil),   // 6: auction.GetAuctionInfoRequest
	(*GetAuctionInfoResponse)(nil),  // 7: auction.GetAuctionInfoResponse
...
var file_proto_auction_auction_proto_depIdxs = []int32{
	...
	12, // 3: auction.GetAuctionInfoResponse.info:type_name -> auction.AuctionInfo
	...
	14, // 6: auction.Bid.tx_list:type_name -> auction.Tx
	12, // 7: auction.AuctionState.auction_info:type_name -> auction.AuctionInfo
	13, // 8: auction.AuctionState.bids:type_name -> auction.Bid
	0,  // 9: auction.AuctionService.StartAuction:input_type -> auction.StartAuctionRequest
	2,  // 10: auction.AuctionService.SubmitBid:input_type -> auction.SubmitBidRequest
	4,  // 11: auction.AuctionService.SubmitBidBatch:input_type -> auction.SubmitBidBatchRequest
	6,  // 12: auction.AuctionService.RequestSaleInfo:input_type -> auction.GetAuctionInfoRequest
	8,  // 13: auction.AuctionService.GetLatestTob:input_type -> auction.GetLatestTobRequest
	10, // 14: auction.AuctionService.GetAuctionState:input_type -> auction.GetAuctionStateRequest
	1,  // 15: auction.AuctionService.StartAuction:output_type -> auction.StartAuctionResponse
	3,  // 16: auction.AuctionService.SubmitBid:output_type -> auction.SubmitBidResponse
	5,  // 17: auction.AuctionService.SubmitBidBatch:output_type -> auction.SubmitBidBatchResponse
	7,  // 18: auction.AuctionService.RequestSaleInfo:output_type -> auction.GetAuctionInfoResponse
	9,  // 19: auction.AuctionService.GetLatestTob:output_type -> auction.GetLatestTobResponse
	11, // 20: auction.AuctionService.GetAuctionState:output_type -> auction.GetAuctionStateResponse
